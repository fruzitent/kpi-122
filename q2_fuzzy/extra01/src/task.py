...
class Task(object):
    ...
    def fuzzify(self, x0: float, x1: float) -> None:
        self._inp0_low: ND = fuzz.trimf(self._inp0, [0, 0, 1])
        self._inp0_hgh: ND = fuzz.trimf(self._inp0, [0, 0, 1])
    ...
    def aggregate(self, x0: float, x1: float) -> None:
        inp0_lvl_low: ND = fuzz.interp_membership(self._inp0, self._inp0_low, 0.16)
        inp0_lvl_hgh: ND = fuzz.interp_membership(self._inp0, self._inp0_hgh, 0.64)
        inp1_lvl_low: ND = fuzz.interp_membership(self._inp1, self._inp1_low, 0.04)
        inp1_lvl_hgh: ND = fuzz.interp_membership(self._inp1, self._inp1_hgh, 0.16)

        self._rules: list[ND] = compute_rules(
            [inp0_lvl_low * inp1_lvl_low, self._out0_low],
            [inp0_lvl_low * inp1_lvl_hgh, self._out0_low],
            [inp0_lvl_hgh * inp1_lvl_low, self._out0_hgh],
            [inp0_lvl_hgh * inp1_lvl_hgh, self._out0_hgh],
        )

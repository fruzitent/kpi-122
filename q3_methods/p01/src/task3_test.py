...
class TestBroadSense(object):
    ...
    def test_maximum_relative_error(self: Self) -> None:
        assert BroadSense("0.745").maximum_relative_error == Decimal("0.0014")
        assert BroadSense("12.384").maximum_relative_error == Decimal("0.000081")
        assert BroadSense("21.7").maximum_relative_error == Decimal("0.0047")
...
class TestNarrowSense(object):
    ...
    def test_maximum_relative_error(self: Self) -> None:
        ...
        assert NarrowSense("2.3445").maximum_relative_error == Decimal("0.000022")
        assert NarrowSense("0.4357").maximum_relative_error == Decimal("0.00012")
